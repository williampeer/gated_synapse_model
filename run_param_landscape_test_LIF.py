...
# free_parameters = ['W_in', 'I_o', 'O']
plot_param_landscape(LIF, [-2., 2.], [-2., 2.], 'W_in', 'O', other_parameters, target_signal, num_steps=num_steps, inputs=current_inputs.clone().detach(), N=int(snn_target.N), fname_addition='auto_encoding')
plot_param_landscape(LIF, [-2., 2.], [-2., 2.], 'W_fast', 'W_syn', other_parameters, target_signal, num_steps=num_steps, inputs=current_inputs.clone().detach(), N=snn_target.N, fname_addition='auto_encoding')
plot_param_landscape(LIF, [-2., 2.], [-2., 2.], 'W_in', 'W_fast', other_parameters, target_signal, num_steps=num_steps, inputs=current_inputs.clone().detach(), N=snn_target.N, fname_addition='auto_encoding')
plot_param_landscape(LIF, [-2., 2.], [-2., 2.], 'W_in', 'W_syn', other_parameters, target_signal, num_steps=num_steps, inputs=current_inputs.clone().detach(), N=snn_target.N, fname_addition='auto_encoding')
