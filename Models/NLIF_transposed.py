...
class NLIF(nn.Module):
    ...
    def __init__(self, N=30, w_mean=0., w_var=0.4):
        ...
        self.O = nn.Parameter(torch.randn((2, self.N)), requires_grad=True)  # linear readout
    ...
    def forward(self, x_in):
        ...
        I_syn = (self.W_syn * self.self_recurrence_mask).matmul((self.s))  # should be pos w recurrence too
